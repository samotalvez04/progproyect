...
public class pantalla {
	...
	private void initialize() {
		...
		table_6.setModel(new DefaultTableModel(
			...
			new String[] {
				"Materia", "Estudiante", "Fecha", "Tipo inasistencia", "Cant. horas"
			}
		));
		...
		scrollPane_1_2.setBounds(0, 66, 442, 176);
		listarMateria.add(scrollPane_1_2);
		...
		scrollPane_1_2.setViewportView(table_4);
